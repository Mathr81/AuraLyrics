// Port of Spring.ts from spicy-lyrics (original: https://github.com/Spikerko/spicy-lyrics)
// Originally a port of https://github.com/Fraktality/spr/blob/master/spr.lua
...
export class Spring {
  ...
  getGoal(): number { return this.g; }
  getPosition(): number { return this.p; }
